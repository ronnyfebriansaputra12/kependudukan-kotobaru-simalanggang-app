            ...
            <tr>
              ...
              <td>
                ...
                <form action="{{ url('/uid-penduduk/'.$value->nik) }}" method="post">
                  @method('PATCH')
                  @csrf
                  <input type="text" class="form-control @error('uid') is-invalid @enderror" name="uid" value="{{ $value->uid }}" onchange="this.form.submit()">
                  @error('uid')
              ...
              <td>
                <div class="d-flex">
                  <a href="#" id="btn-camera" class="btn btn-success btn-sm me-1" data-id="{{ $value->nik }}"><i class="fa-solid fas fa-camera"></i>
                  </a>
                  <button type="button" id="{{ $value->nik }}" class="btn btn-info btn-sm btn-detail me-1">
      ...
      <div class="modal-body">
        ...
        <form action="/penduduk-excel" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control @error('file') is-invalid @enderror" id="file" name="file" placeholder="File Excle" autofocus>
          </div>
