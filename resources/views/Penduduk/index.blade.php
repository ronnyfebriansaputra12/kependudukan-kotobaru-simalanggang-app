...
<div class="container">
  ...
  <div class="card card-outline card-success mt-3">
    <div class="card-header">
      ...
      <a href="/penduduk" class=" ml-2 btn btn-secondary" title="reset"> <i class="fas fa-sync-alt" title="reset"></i></a>
      <button type="button" class="btn btn-outline-success float-right col-sm-" data-bs-toggle="modal" data-bs-target="#exampleModalExcle">
