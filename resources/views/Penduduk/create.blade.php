                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                        ...
                                        placeholder="pekerjaan Anda" autofocus required>
                                </div>
                                @error('pekerjaan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('tmp_lahir') is-invalid @enderror"
                                        id="tmp_lahir" value="{{ old('tmp_lahir') }}" name="tmp_lahir"
                                        placeholder="Tempat Lahir" autofocus required>
                                </div>
                                @error('tmp_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        id="alamat" value="{{ old('alamat') }}" name="alamat" placeholder="Alamat"
                                        autofocus required>
                                </div>
                                @error('alamat')
                                    <div class="invalid-feedback">
