        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                ...
                @elseif ($admin && Auth::check())
                    @if (Auth::user()->avatar)
                        <img class="img-circle elevation-2" src="{{ asset(Auth::user()->avatar) }}"
                            alt="User profile picture">
                    @else
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                @if (session()->has('penduduk'))
                    <li class="nav-item" {{ Request::is('pengajuan') ? 'menu-is-opening menu-open' : '' }}>
                ...
                @elseif (session()->has('admin'))
                    <li
                        class="nav-item {{ Request::is('penduduk', 'user', 'jenis-surat', 'pengajuan','pengguna') ? 'menu-is-opening menu-open' : '' }}">
                        <a class="nav-link {{ Request::is('penduduk', 'user', 'jenis-surat', 'pengajuan','pengguna') ? 'active' : '' }}"
