...
<aside class="main-sidebar elevation-4 sidebar-light-success">
  ...
  <a href="/dashboard" class="brand-link" style="text-decoration: none">
    <img src="{{ asset('AdminLTE') }}/dist/img/50kota.png" width="70px" alt="AdminLTE Logo" class="brand-image img-circle">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info my-auto">
        ...
        // dd($admin)
        @endphp
        <a href="{{ url('profileAdmin/' . $admin->id) }}" style="text-decoration: none;">{{ $admin->name }}</a>
        @endif
      </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if (session()->has('penduduk'))
        <li class="nav-item">
          <a class="nav-link {{ Request::is('pengajuan') ? 'active' : '' }}" onclick="toggleActive(this)" style="background-color: {{ Request::is('pengajuan') ? 'warning' : '' }}; color: dark;">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('penduduk', 'user', 'jenis-surat', 'pengajuan') ? 'active' : '' }}" onclick="toggleActive(this)" style="background-color: {{ Request::is('penduduk', 'user', 'surat', 'pengajuan') ? 'warning' : '' }}; color: dark;">
