            ...
            <div class="row">
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  <input type="text" nama="nama" value="{{ $penduduk->nama }}" class="form-control" id="nama" require readonly>
                </div>
                <div class="form-group">
                  <input type="text" name="nik_penduduk" value="{{ $penduduk->nik }}" class="form-control" id="nama" hidden>
                </div>
                <div class="form-group">
                  <label for="tmp_lahir">Tempat Lahir</label>
                  <input type="text" name="tmp_lahir" value="{{ $penduduk->tmp_lahir }}" class="form-control" id="tmp_lahir" require readonly>
                </div>
                <div class="form-group">
                  <label for="tgl_lahir">Tanggal Lahir</label>
                  <input type="date"name="tgl_lahir" value="{{ $penduduk->tgl_lahir }}" class="form-control" id="tgl_lahir" require readonly>
                </div>
                <div class="form-group">
                  <label for="jekel">Jenis Kelamin</label>
                  <input type="text" name="jekel" value="{{ $penduduk->jekel }}" class="form-control" id="jekel" require readonly>
                </div>
                <div class="form-group">
                  <label for="agama">Agama</label>
                  <input type="text" name="agama" value="{{ $penduduk->agama }}" class="form-control" id="agama" require readonly>
                </div>
                <div class="form-group">
                  <label for="alamat">Alamat</label>
                  <input type="text" name="alamat" value="{{ $penduduk->alamat }}" class="form-control" id="alamat" require readonly>
                </div>
                <div class="form-group">
                  <label for="pekerjaan">Pekerjaan</label>
                  <input type="text" name="pekerjaan" value="{{ $penduduk->pekerjaan }}" class="form-control" id="pekerjaan" require readonly>
                </div>
              </div>
              ...
              <div class="col">
                ...
                <div id="form_keterangan_tidak_mampu" style="display: none">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_orangtua" class="form-control" id="nama_orangtua" placeholder="Masukkan Nama Orang Tua">
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="jekel_orangtua" id="jekel_laki" value="Laki-Laki" checked>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="jekel_orangtua" id="jekel_perempuan" value="Perempuan">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="umur_orangtua" class="form-control" id="umur_orangtua" placeholder="Masukkan Umur Orangtua">
                  </div>
                  <div class="form-group">
                    <label for="pekerjaan_orangtua">Pekerjaan</label>
                    <input type="text" name="pekerjaan_orangtua" class="form-control" id="pekerjaan_orangtua" placeholder="Masukkan Pekerjaan Orang Tua">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group" id="form_keterangan_kematian" style="display: none">
                  ...
                  <input type="text" name="name_jenazah" class="form-control" id="name_jenazah" placeholder="Enter Nama Jenazah">
                </div>
                <div class="form-group" id="tanggal_kematians" style="display: none">
                  <label for="tanggal_kematian">Tanggal Kematian *</label>
                  <input type="date" name="tanggal_kematian" class="form-control" id="tanggal_kematian" placeholder="Enter Tanggal Lahir Bayi">
                </div>
                <div class="form-group" id="waktu_kematians" style="display: none">
                  <label for="waktu_kematian">Waktu Kematian *</label>
                  <input type="time" name="waktu_kematian" class="form-control" id="waktu_kematian" placeholder="Enter Waktu Kematian">
                </div>
                ...
                <div class="form-group" id="tempat_kematians" style="display: none">
                  ...
                  <input type="text" name="tempat_kematian" class="form-control" id="tempat_kematian" placeholder="Enter Tempat Kematian">
                </div>
                <div class="form-group" id="saksi_keterangan_kematians" style="display: none">
                  ...
                  <select name="saksi_keterangan_kematian" class="form-control" id="saksi_keterangan_kematian">
